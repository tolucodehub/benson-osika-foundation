      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            transition={{ duration: 4, repeat: Infinity }}
          >
            <Quote className="w-10 h-10 md:w-14 md:h-14 text-accent mx-auto mb-6 md:mb-8 opacity-40" />
          </motion.div>
          ...
          <div className="min-h-[140px] md:min-h-[180px] flex flex-col items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-xl md:text-3xl lg:text-4xl font-serif text-foreground leading-relaxed mb-6 md:mb-8 px-2">
